...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        """Load default engines. Creates any engine from YAML that does not exist yet (preserves existing)."""
        ...
        for yaml_file in yaml_files:
            ...
            try:
                ...
                # Create only if engine does not exist (preserves user modifications)
        ...
        self.stdout.write(
            self.style.SUCCESS(f'\nSuccessfully loaded {loaded_count} new default scan engines.')
        ) 