    ...
    slack_hook_url = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "class": "form-control",
                "id": "slack_hook_url",
                "placeholder": "Enter your Slack Incoming Webhook URL from Slack app settings",
            }))
...
**{company_name}** performed both Security Audit and Reconnaissance using automated tool BoltR. https://github.com/Security-Tools-Alliance/rengine-ng/.
